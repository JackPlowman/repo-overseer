...
export const RepositorySecurityColumns: ColumnDef<Repository>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <Button variant="ghost" onClick={() => column.toggleSorting()} data-testid="secret-scanning-push-protection">
  ...
  },
  {
    ...
    header: ({ column }) => (
      <Button variant="ghost" onClick={() => column.toggleSorting()} data-testid="secret-scanning">
        <div className="flex items-center gap-2">
  ...
  },
  {
    ...
    header: ({ column }) => (
      <Button variant="ghost" onClick={() => column.toggleSorting()} data-testid="dependabot-security-updates">
        <div className="flex items-center gap-2">
  ...
  },
  {
    ...
    header: ({ column }) => (
      <Button variant="ghost" onClick={() => column.toggleSorting()} data-testid="private-vulnerability-disclosures">
        <div className="flex items-center gap-2">
  ...
  },
  {
    ...
    header: ({ column }) => (
      <Button variant="ghost" onClick={() => column.toggleSorting()} data-testid="code-scanning-alerts">
        <div className="flex items-center gap-2">
          <MessageCircleWarning className="h-4 w-4" />
